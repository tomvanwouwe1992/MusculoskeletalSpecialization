...
labels_models = ('scaling', 'no foot scaling', 'foot inertia fixed')
...
sprintingSpeeds[0] = np.round_(optimaltrajectories['2']['model_mass'], decimals=1)
sprintingSpeeds[1] = np.round_(optimaltrajectories['22']['model_mass'], decimals=1)
sprintingSpeeds[2] = np.round_(optimaltrajectories['42']['model_mass'], decimals=1)
...
# generate legend
labels_models_2 = ('top 7 marathoners', 'top 7 sprinters', 'scaling', 'no foot scaling', 'inertia foot fixed')
plt.legend(labels_models_2,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('mass [kg]')
plt.savefig('figures_presentation/mass_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/mass_morphology_foot.jpg',format = 'jpg', dpi = 600)


## height
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.round_(optimaltrajectories['2']['modelHeight'], decimals=2)
sprintingSpeeds[1] = np.round_(optimaltrajectories['22']['modelHeight'], decimals=2)
sprintingSpeeds[2] = np.round_(optimaltrajectories['42']['modelHeight'], decimals=2)
...
plt.legend(labels_models_2,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('height [m]')
plt.savefig('figures_presentation/height_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/height_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.around(optimaltrajectories['2']['speed'], decimals=2)
sprintingSpeeds[1] = np.around(optimaltrajectories['22']['speed'], decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['42']['speed'], decimals=2)
...
plt.savefig('figures_presentation/max_running_speed_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.around(optimaltrajectories['2']['coordinate_values'][3,-1] / 2, decimals=2)
sprintingSpeeds[1] = np.around(optimaltrajectories['22']['coordinate_values'][3,-1] / 2, decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['42']['coordinate_values'][3,-1] / 2, decimals=2)
...
plt.savefig('figures_presentation/step_length_sprinting_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/step_length_sprinting_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.around( 1 / optimaltrajectories['2']['time'][0,-1] * 2, decimals=2)
sprintingSpeeds[1] = np.around( 1 / optimaltrajectories['22']['time'][0,-1] * 2, decimals=2)
sprintingSpeeds[2] = np.around( 1 / optimaltrajectories['42']['time'][0,-1] * 2, decimals=2)
...
plt.savefig('figures_presentation/step_frequency_sprinting_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/step_frequency_sprinting_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
GRF = optimaltrajectories['22']['GRF']
time = optimaltrajectories['22']['time']
idx1 = np.argmax(GRF[4,:]>10)
idx2 = idx1 + np.argmax(GRF[4,idx1:]<10)
sprintingSpeeds[1] = np.round_(1000*time[0,idx2] - 1000*time[0,idx1], decimals=0)
GRF = optimaltrajectories['42']['GRF']
time = optimaltrajectories['42']['time']
idx1 = np.argmax(GRF[4,:]>10)
idx2 = idx1 + np.argmax(GRF[4,idx1:]<10)
...
plt.savefig('figures_presentation/contact_time_sprinting_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/contact_time_sprinting_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
max_iso_force[0,:] = np.reshape(optimaltrajectories['2']['maximal_isometric_force_original'],(1,92))
max_iso_force[1,:] = np.reshape(optimaltrajectories['22']['maximal_isometric_force_scaled'],(1,92)) / max_iso_force[0,:]
max_iso_force[2,:] = np.reshape(optimaltrajectories['42']['maximal_isometric_force_scaled'],(1,92)) / max_iso_force[0,:]
...
plt.savefig('figures_presentation/muscle_adaptation_sagittal_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/muscle_adaptation_sagittal_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
plt.tight_layout(pad=1.08, h_pad=None, w_pad=None, rect=None)
plt.savefig('figures_presentation/muscle_adaptation_frontal_coronal_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/muscle_adaptation_frontal_coronal_morphology_foot.jpg',format = 'jpg', dpi = 600)
...
body_scaling[0,:] = np.round_(optimaltrajectories['2']['body_scaling'], decimals=2)
body_scaling[1,:] = np.round_(optimaltrajectories['22']['body_scaling'], decimals=2)
body_scaling[2,:] = np.round_(optimaltrajectories['42']['body_scaling'], decimals=2)
...
plt.savefig('figures_presentation/body_scaling_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/body_scaling_morphology_foot.jpg',format = 'jpg', dpi =1200)
...
maxIsoTorque_torques[0,:,:] = optimaltrajectories['2']['maxIsoTorque_torques']
maxIsoTorque_torques[1,:,:] = optimaltrajectories['22']['maxIsoTorque_torques']
maxIsoTorque_torques[2,:,:] = optimaltrajectories['42']['maxIsoTorque_torques']
maxIsoTorque_joint_pose = np.zeros((3,17,20,6))
maxIsoTorque_joint_pose[0,:,:,:] = optimaltrajectories['2']['maxIsoTorque_joint_pose']
maxIsoTorque_joint_pose[1,:,:,:] = optimaltrajectories['22']['maxIsoTorque_joint_pose']
maxIsoTorque_joint_pose[2,:,:,:] = optimaltrajectories['42']['maxIsoTorque_joint_pose']
maxIsoTorque_passive_torques = np.zeros((3,20,6))
maxIsoTorque_passive_torques[0,:,:] = optimaltrajectories['2']['maxIsoTorque_passivetorques']
maxIsoTorque_passive_torques[1,:,:] = optimaltrajectories['22']['maxIsoTorque_passivetorques']
maxIsoTorque_passive_torques[2,:,:] = optimaltrajectories['42']['maxIsoTorque_passivetorques']
...
labels_models_torques = ('scaling', 'foot scaling fixed', 'fixed inertia','generic (passive)', 'marathon morphology (passive)', 'sprinting morphology (passive)')
...
plt.savefig('figures_presentation/max_iso_torque_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/max_iso_torque_morphology_foot.jpg',format = 'jpg', dpi =1200)
...
plt.savefig('figures_presentation/max_iso_torque_simple_morphology_foot.svg',format = 'svg')
plt.savefig('figures_presentation/max_iso_torque_simple_morphology_foot.jpg',format = 'jpg', dpi =1200)