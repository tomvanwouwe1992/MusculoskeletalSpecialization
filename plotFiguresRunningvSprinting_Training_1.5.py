...
labels_models = ('generic', 'marathon training', 'sprint training')
...
sprintingSpeeds[0] = np.round_(optimaltrajectories['6']['model_mass'], decimals=1)
sprintingSpeeds[1] = np.round_(optimaltrajectories['9']['model_mass'], decimals=1)
sprintingSpeeds[2] = np.round_(optimaltrajectories['4']['model_mass'], decimals=1)
...
plt.title('mass [kg]')
# plt.savefig('figures_presentation/mass_training.svg',format = 'svg')
# plt.savefig('figures_presentation/mass_training.jpg',format = 'jpg', dpi = 600)


## height
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.round_(optimaltrajectories['6']['modelHeight'], decimals=2)
sprintingSpeeds[1] = np.round_(optimaltrajectories['9']['modelHeight'], decimals=2)
sprintingSpeeds[2] = np.round_(optimaltrajectories['4']['modelHeight'], decimals=2)
...
plt.legend(labels_models_2,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('height [m]')
# plt.savefig('figures_presentation/height_training.svg',format = 'svg')
# plt.savefig('figures_presentation/height_training.jpg',format = 'jpg', dpi = 600)
...
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.around(optimaltrajectories['15']['speed'], decimals=2)
sprintingSpeeds[1] = 0*np.around(optimaltrajectories['9']['speed'], decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['14']['speed'], decimals=2)
...
plt.savefig('figures_presentation/max_running_speed_training_1.5.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_training_1.5.jpg',format = 'jpg', dpi = 600)
...
# sprintingSpeeds[1] = np.round_(optimaltrajectories['3']['COT'], decimals=2)
# sprintingSpeeds[2] = np.round_(optimaltrajectories['10']['COT'] + 0.004, decimals=2)
#
# # Setup x-axis
# sprintingSpeeds_x = np.array((1,2,3))
# # Set-up figure canvas
...
# plt.savefig('figures_presentation/cost_of_transport_marathon_training.svg',format = 'svg')
# plt.savefig('figures_presentation/cost_of_transport_marathon_training.jpg',format = 'jpg', dpi = 600)
#
#
#
...
# sprintingSpeeds[1] = np.round_(optimaltrajectories['3']['COT']*optimaltrajectories['3']['model_mass']*42196*0.000239006, decimals=0)
# sprintingSpeeds[2] = np.round_(optimaltrajectories['10']['COT']*optimaltrajectories['10']['model_mass']*42196*0.000239006, decimals=0)
#
# # Setup x-axis
# sprintingSpeeds_x = np.array((1,2,3))
# # Set-up figure canvas
...
# plt.savefig('figures_presentation/absolute_energy_cost_training.svg',format = 'svg')
# plt.savefig('figures_presentation/absolute_energy_cost_training.jpg',format = 'jpg', dpi = 600)
#
#
#
#
...
# sprintingSpeeds[1] = np.round_(optimaltrajectories['3']['objective_terms']['metabolicEnergyRateTerm'] + optimaltrajectories['3']['objective_terms']['activationTerm'] + optimaltrajectories['3']['objective_terms']['armExcitationTerm'] + optimaltrajectories['3']['objective_terms']['jointAccelerationTerm'], decimals=0)
# sprintingSpeeds[2] = np.round_(optimaltrajectories['10']['objective_terms']['metabolicEnergyRateTerm'] + optimaltrajectories['10']['objective_terms']['activationTerm'] + optimaltrajectories['10']['objective_terms']['armExcitationTerm'] + optimaltrajectories['10']['objective_terms']['jointAccelerationTerm'], decimals=0)
#
# # Setup x-axis
# sprintingSpeeds_x = np.array((1,2,3))
# # Set-up figure canvas
...
#
# plt.savefig('figures_presentation/energy_cost_function_training.svg',format = 'svg')
# plt.savefig('figures_presentation/energy_cost_function_training.jpg',format = 'jpg', dpi = 600)
#
#
#
# ########## MUSCLES #########
...
# max_iso_force[1,:] = np.reshape(optimaltrajectories['3']['maximal_isometric_force_scaled'],(1,92)) / max_iso_force[0,:]
# max_iso_force[2,:] = np.reshape(optimaltrajectories['10']['maximal_isometric_force_scaled'],(1,92)) / max_iso_force[0,:]
...
# plt.savefig('figures_presentation/muscle_adaptation_sagittal_training.svg',format = 'svg')
# plt.savefig('figures_presentation/muscle_adaptation_sagittal_training.jpg',format = 'jpg', dpi = 600)
#
#
...
#
# plt.tight_layout(pad=1.08, h_pad=None, w_pad=None, rect=None)
# plt.savefig('figures_presentation/muscle_adaptation_frontal_coronal_training.svg',format = 'svg')
# plt.savefig('figures_presentation/muscle_adaptation_frontal_coronal_training.jpg',format = 'jpg', dpi = 600)
#
#
#
#
...
# body_scaling[1,:] = np.round_(optimaltrajectories['3']['body_scaling'], decimals=2)
# body_scaling[2,:] = np.round_(optimaltrajectories['10']['body_scaling'], decimals=2)
#
#
#
# fig = plt.figure(figsize=(14,8))
...
# plt.tight_layout(pad=1.08, h_pad=None, w_pad=None, rect=None)
#
# plt.savefig('figures_presentation/body_scaling_training.svg',format = 'svg')
# plt.savefig('figures_presentation/body_scaling_training.jpg',format = 'jpg', dpi =1200)
#
#
#
#
...
# maxIsoTorque_torques[1,:,:] = optimaltrajectories['3']['maxIsoTorque_torques']
# maxIsoTorque_torques[2,:,:] = optimaltrajectories['10']['maxIsoTorque_torques']
# maxIsoTorque_joint_pose = np.zeros((3,17,20,6))
# maxIsoTorque_joint_pose[0,:,:,:] = optimaltrajectories['5']['maxIsoTorque_joint_pose']
# maxIsoTorque_joint_pose[1,:,:,:] = optimaltrajectories['3']['maxIsoTorque_joint_pose']
# maxIsoTorque_joint_pose[2,:,:,:] = optimaltrajectories['10']['maxIsoTorque_joint_pose']
...
# maxIsoTorque_passive_torques[1,:,:] = optimaltrajectories['3']['maxIsoTorque_passivetorques']
# maxIsoTorque_passive_torques[2,:,:] = optimaltrajectories['10']['maxIsoTorque_passivetorques']
#
...
# plt.tight_layout(pad=1.08, h_pad=None, w_pad=None, rect=None)
#
# plt.savefig('figures_presentation/max_iso_torque_training.svg',format = 'svg')
# plt.savefig('figures_presentation/max_iso_torque_training.jpg',format = 'jpg', dpi =1200)
#
#
#
#
...
# plt.savefig('figures_presentation/max_iso_torque_simple_training.svg',format = 'svg')
# plt.savefig('figures_presentation/max_iso_torque_simple_training.jpg',format = 'jpg', dpi =1200)
