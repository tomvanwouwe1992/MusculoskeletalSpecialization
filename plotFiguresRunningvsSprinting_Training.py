...
sprintingSpeeds[1] = np.around(optimaltrajectories['9']['speed'], decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['4']['speed'], decimals=2)
...
plt.savefig('figures_presentation/max_running_speed_training.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_training.jpg',format = 'jpg', dpi = 600)
...
sprintingSpeeds[1] = np.round_(optimaltrajectories['10']['COT']*optimaltrajectories['3']['model_mass']*42196*0.000239006, decimals=0)
sprintingSpeeds[2] = np.round_(optimaltrajectories['3']['COT']*optimaltrajectories['10']['model_mass']*42196*0.000239006, decimals=0)
