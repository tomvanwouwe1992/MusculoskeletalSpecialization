...
sprintingSpeeds[2] = np.around(optimaltrajectories['34']['speed'], decimals=2)
...
plt.savefig('figures_presentation/max_running_speed_training_2.0.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_training_2.0.jpg',format = 'jpg', dpi = 600)
