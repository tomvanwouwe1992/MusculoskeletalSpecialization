...
labels_models_strength = ('baseline x1', 'baseline x1.5', 'baseline x2')
...
sprintingSpeeds[0] = np.round_(optimaltrajectories['15']['model_mass'], decimals=1)
sprintingSpeeds[1] = np.round_(optimaltrajectories['17']['model_mass'], decimals=1)
sprintingSpeeds[2] = np.round_(optimaltrajectories['12']['model_mass'], decimals=1)
...
plt.title('mass [kg]')
plt.savefig('figures_presentation/mass_morphology_1.5.svg',format = 'svg')
plt.savefig('figures_presentation/mass_morphology_1.5.jpg',format = 'jpg', dpi = 600)


## height
# Generate data matrix/vector to plot
sprintingSpeeds = np.zeros((3,))
sprintingSpeeds[0] = np.round_(optimaltrajectories['15']['modelHeight'], decimals=2)
sprintingSpeeds[1] = np.round_(optimaltrajectories['17']['modelHeight'], decimals=2)
sprintingSpeeds[2] = np.round_(optimaltrajectories['12']['modelHeight'], decimals=2)
...
plt.legend(labels_models_2,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('height [m]')
plt.savefig('figures_presentation/height_morphology_1.5.svg',format = 'svg')
plt.savefig('figures_presentation/height_morphology_1.5.jpg',format = 'jpg', dpi = 600)
...
sprintingSpeeds[1] = np.around(optimaltrajectories['17']['speed'], decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['12']['speed'], decimals=2)
...
plt.savefig('figures_presentation/max_running_speed_morphology_1.5.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_morphology_1.5.jpg',format = 'jpg', dpi = 600)
...
sprintingSpeeds[1] = np.around(optimaltrajectories['15']['speed'], decimals=2)
sprintingSpeeds[2] = np.around(optimaltrajectories['35']['speed'], decimals=2)
...
# Setup
for i in range(len(sprintingSpeeds)):
    bar_i = ax.bar(x = sprintingSpeeds_x[i], height = sprintingSpeeds[i], width = 0.5, color = colormap_5[i], label = labels_models_strength[i])
    ax.bar_label(bar_i) # add bar label
...
# generate legend
plt.legend(labels_models_strength,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('maximal running speed [m/s]')
plt.savefig('figures_presentation/max_running_speed_different_strength.svg',format = 'svg')
plt.savefig('figures_presentation/max_running_speed_different_strength.jpg',format = 'jpg', dpi = 600)
