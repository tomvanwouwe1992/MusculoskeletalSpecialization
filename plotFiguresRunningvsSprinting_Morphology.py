...
sprintingSpeeds[1] = np.round_(optimaltrajectories['7']['model_mass'], decimals=1)
sprintingSpeeds[2] = np.round_(optimaltrajectories['2']['model_mass'], decimals=1)
...
plt.title('mass [kg]')
plt.savefig('figures_presentation/mass_morphology.svg',format = 'svg')
plt.savefig('figures_presentation/mass_morphology.jpg',format = 'jpg', dpi = 600)
...
sprintingSpeeds[1] = np.round_(optimaltrajectories['7']['modelHeight'], decimals=2)
sprintingSpeeds[2] = np.round_(optimaltrajectories['2']['modelHeight'], decimals=2)
...
plt.legend(labels_models_2,loc='upper left',bbox_to_anchor=(1,0.5))
plt.title('height [m]')
plt.savefig('figures_presentation/height_morphology.svg',format = 'svg')
plt.savefig('figures_presentation/height_morphology.jpg',format = 'jpg', dpi = 600)
