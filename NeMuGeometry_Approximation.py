...
from NeMuGeometrySubfunctions import trainNeMu_Geometry
...
if __name__ == '__main__':
    ...
    # FLOW CONTROL
    #####################################################################
    generate_randomly_scaled_models = 0
    generate_ground_truth_data_all_muscles = 0
    ...
    model_path = root_path + '/OpenSimModel/Hamner_modified/Model/'
    # save_path = 'C:/Users/tom_v/OneDrive/Documenten/OpenSimModel/Hamner_modified/Model/NeMu/tanh/'
    save_path = root_path + '/OpenSimModel/Hamner_modified/Model/NeMu/' + activation_function + '/'
    ...
    ######################################################################
    # --- PART 3: Train NeMu's based on generated data
    ######################################################################
