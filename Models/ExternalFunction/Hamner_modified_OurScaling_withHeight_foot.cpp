...
int F_generic(const T** arg, T** res) {
	...
	osim_double_adouble target_mass = s[42]; // not used here
	...
	*/
	...
	talus_r = new OpenSim::Body("talus_r", talus_r_original_mass, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00100000000000000002 , 0.00100000000000000002  , 0.00100000000000000002, 0., 0., 0.));
	model->addBody(talus_r);

	OpenSim::Body* calcn_r;
	calcn_r = new OpenSim::Body("calcn_r", calcn_r_original_mass, Vec3(0.10000000000000000555, 0.02999999999999999889, 0.00000000000000000000), Inertia(0.00139999999999999999, 0.00389999999999999982, 0.00410000000000000035, 0., 0., 0.));
	model->addBody(calcn_r);

	OpenSim::Body* toes_r;
	toes_r = new OpenSim::Body("toes_r", toes_r_original_mass, Vec3(0.03459999999999999881, 0.00600000000000000012, -0.01750000000000000167),  Inertia(0.00010000000000000000 , 0.00020000000000000001 , 0.00100000000000000002, 0., 0., 0.));
	...
	talus_l = new OpenSim::Body("talus_l", talus_l_original_mass, Vec3(0.00000000000000000000, 0.00000000000000000000, 0.00000000000000000000), Inertia(0.00100000000000000002, 0.00100000000000000002, 0.00100000000000000002, 0., 0., 0.));
	model->addBody(talus_l);

	OpenSim::Body* calcn_l;
	calcn_l = new OpenSim::Body("calcn_l", calcn_l_original_mass, Vec3(0.10000000000000000555, 0.02999999999999999889, 0.00000000000000000000),  Inertia(0.00139999999999999999 , 0.00389999999999999982, 0.00410000000000000035, 0., 0., 0.));
	model->addBody(calcn_l);

	OpenSim::Body* toes_l;
	toes_l = new OpenSim::Body("toes_l", toes_l_original_mass, Vec3(0.03459999999999999881, 0.00600000000000000012, 0.01750000000000000167), Inertia(0.00010000000000000000, 0.00020000000000000001, 0.00100000000000000002, 0., 0., 0.));
