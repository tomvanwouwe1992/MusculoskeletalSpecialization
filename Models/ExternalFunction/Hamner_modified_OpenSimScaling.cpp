...
int F_generic(const T** arg, T** res) {
	...
	osim_double_adouble s_torso_x = s[0];
	osim_double_adouble s_torso_y = s[1];
	osim_double_adouble s_torso_z = s[2];
	
	osim_double_adouble s_pelvis_x = s[3];
	osim_double_adouble s_pelvis_y = s[4];
	osim_double_adouble s_pelvis_z = s[5];

	osim_double_adouble s_femur_l_x = s[6];
	osim_double_adouble s_femur_l_y = s[7];
	osim_double_adouble s_femur_l_z = s[8];

	osim_double_adouble s_tibia_l_x = s[9];
	osim_double_adouble s_tibia_l_y = s[10];
	osim_double_adouble s_tibia_l_z = s[11];

	osim_double_adouble s_talus_l_x = s[12];
	osim_double_adouble s_talus_l_y = s[13];
	osim_double_adouble s_talus_l_z = s[14];
	
	osim_double_adouble s_calcn_l_x = s[12];
	osim_double_adouble s_calcn_l_y = s[13];
	osim_double_adouble s_calcn_l_z = s[14];
	
	osim_double_adouble s_toes_l_x = s[12];
	osim_double_adouble s_toes_l_y = s[13];
	osim_double_adouble s_toes_l_z = s[14];

	osim_double_adouble s_femur_r_x = s[15];
	osim_double_adouble s_femur_r_y = s[16];
	osim_double_adouble s_femur_r_z = s[17];

	osim_double_adouble s_tibia_r_x = s[18];
	osim_double_adouble s_tibia_r_y = s[19];
	osim_double_adouble s_tibia_r_z = s[20];

	osim_double_adouble s_talus_r_x = s[21];
	osim_double_adouble s_talus_r_y = s[22];
	osim_double_adouble s_talus_r_z = s[23];	
	
	osim_double_adouble s_calcn_r_x = s[21];
	osim_double_adouble s_calcn_r_y = s[22];
	osim_double_adouble s_calcn_r_z = s[23];
	
	osim_double_adouble s_toes_r_x = s[21];
	osim_double_adouble s_toes_r_y = s[22];
	osim_double_adouble s_toes_r_z = s[23];

	osim_double_adouble s_humerus_l_x = s[24];
	osim_double_adouble s_humerus_l_y = s[25];
	osim_double_adouble s_humerus_l_z = s[26];

	osim_double_adouble s_radiusulnar_l_x = s[27];
	osim_double_adouble s_radiusulnar_l_y = s[28];
	osim_double_adouble s_radiusulnar_l_z = s[29];

	osim_double_adouble s_hand_l_x = s[30];
	osim_double_adouble s_hand_l_y = s[31];
	osim_double_adouble s_hand_l_z = s[32];

	osim_double_adouble s_humerus_r_x = s[33];
	osim_double_adouble s_humerus_r_y = s[34];
	osim_double_adouble s_humerus_r_z = s[35];

	osim_double_adouble s_radiusulnar_r_x = s[36];
	osim_double_adouble s_radiusulnar_r_y = s[37];
	osim_double_adouble s_radiusulnar_r_z = s[38];

	osim_double_adouble s_hand_r_x = s[39];
	osim_double_adouble s_hand_r_y = s[40];
	osim_double_adouble s_hand_r_z = s[41];

	osim_double_adouble target_mass = s[42];
    ...
    // Rescaling to achieve target mass
    osim_double_adouble ratio_target_mass_volume_scaled_mass = target_mass/total_original_mass;

	// Segment mass scaling factor
	osim_double_adouble pelvis_mass_scaling = ratio_target_mass_volume_scaled_mass;

	osim_double_adouble femur_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble tibia_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble talus_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble calcn_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble toes_r_mass_scaling = ratio_target_mass_volume_scaled_mass;

	osim_double_adouble femur_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble tibia_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble talus_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble calcn_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble toes_l_mass_scaling = ratio_target_mass_volume_scaled_mass;

	osim_double_adouble torso_mass_scaling = ratio_target_mass_volume_scaled_mass;

	osim_double_adouble humerus_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble radius_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble ulna_r_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble hand_r_mass_scaling = ratio_target_mass_volume_scaled_mass;

	osim_double_adouble humerus_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble radius_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble ulna_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	osim_double_adouble hand_l_mass_scaling = ratio_target_mass_volume_scaled_mass;
	...
	res[0][103] = value<T>(ratio_target_mass_volume_scaled_mass);
	return 0;
}
