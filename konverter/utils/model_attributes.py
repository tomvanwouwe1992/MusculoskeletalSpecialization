...
class Activations:
  ...
  class Tanh(_BaseActivation):
    ...
    alias = 'tanh'
    string = 'ca.tanh({})'  # don't define a function if you don't want your string added to file as a function
    needs_function = False
...
class Layers:
  ...
  class Dense(_BaseLayer):
    ...
    string = 'ca.mtimes({}, w[{}]) + ca.transpose(b[{}])'  # n0 is the previous layer, n1 is weight, n2 is bias
